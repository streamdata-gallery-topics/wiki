...
- name: Wikipedia
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/wiki/master/_listings/wikipedia/metrics-pageviews-aggregate-project-access-agent-granularity-start-end-get.md
x-common:
- type: x-base
