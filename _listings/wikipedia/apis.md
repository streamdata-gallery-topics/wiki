...
- name: Wikipedia
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/wiki/master/_listings/wikipedia/metrics-bytes-difference-absolute-aggregate-project-editor-type-page-type-granularity-start-end-get.md
x-common:
- type: x-base
