...
- name: Wikipedia
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/wiki/master/_listings/wikipedia/metrics-edited-pages-top-by-net-bytes-difference-project-editor-type-page-type-granularity-start-end-get.md
x-common:
- type: x-base
